...
public class Mmain {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < animals.length; i++) {
            if (i % 2 == 0) {
                animals[i] = new Cat(names[rnd.nextInt(names.length)], colors[rnd.nextInt(colors.length)], rnd.nextInt(20));
            } else {
                animals[i] = new Dog(names[rnd.nextInt(names.length)], colors[rnd.nextInt(colors.length)], rnd.nextInt(20));
            }
        }
